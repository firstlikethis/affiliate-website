...
@section('head')
    <title>404 ไม่พบหน้าที่คุณค้นหา - {{ config('app.name') }}</title>
...
<div class="flex items-center justify-center min-h-[60vh] py-16">
    <div class="text-center px-6">
        <div class="mb-8">
            <img src="{{ asset('images/404-illustration.svg') }}" alt="Page not found" class="h-64 mx-auto">
        </div>
        <h1 class="text-5xl font-bold text-gray-800 mb-4">404</h1>
        <h2 class="text-2xl font-medium text-gray-700 mb-6">ขออภัย ไม่พบหน้าที่คุณกำลังค้นหา</h2>
        <p class="text-gray-600 max-w-md mx-auto mb-8">
            เนื้อหาอาจถูกลบไปแล้ว ขออภัยในความไม่สะดวก
        </p>
