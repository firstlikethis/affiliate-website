                    ...
                    @if(count($tags) > 0)
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            <div class="flex flex-wrap gap-2">
                                @foreach($tags as $tag)
                                    <a href="{{ route('article.tag', ['tag' => $tag]) }}" class="px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-full hover:bg-purple-100 hover:text-purple-700">
                                        {{ $tag->name }}
                                    </a>
                                @endforeach
                            </div>
                        ...
                        <div class="p-6 md:p-8">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                @foreach($relatedArticles as $relatedArticle)
                                    <a href="{{ route('article.show', ['article' => $relatedArticle]) }}" class="flex items-center group">
