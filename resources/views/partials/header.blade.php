<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="{{ route('home') }}" class="text-2xl font-bold text-purple-600 flex items-center">
            ...
            <nav class="hidden md:ml-6 md:flex md:items-center md:space-x-4">
                <a href="{{ route('home') }}" class="px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('home') ? 'text-purple-600' : 'text-gray-700 hover:text-purple-600' }}">
                    หน้าแรก
                </a>
                
                <!-- Categories Dropdown -->
                <div class="relative group">
                    <button class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-purple-600 flex items-center">
                        หมวดหมู่
                ...
                <!-- Latest Articles -->
                <a href="{{ route('home') }}#latest-articles" class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-purple-600">
                    บทความล่าสุด
                </a>
            </nav>
            ...
            <div class="flex items-center md:hidden">
                <button type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-purple-600 hover:bg-gray-100" onclick="toggleMobileMenu()">
    ...
    <div class="md:hidden hidden" id="mobile-menu">
        <div class="pt-2 pb-3 space-y-1 px-4 sm:px-6 lg:px-8">
            <a href="{{ route('home') }}" class="block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('home') ? 'text-purple-600 bg-purple-50' : 'text-gray-700 hover:bg-gray-100' }}">
                หน้าแรก
            </a>
